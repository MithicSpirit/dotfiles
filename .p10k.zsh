# Generated by Powerlevel10k configuration wizard on 2020-10-02 at 14:47 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 38533.
# Wizard options: powerline, lean_8colors, unicode, 24h time, 2 lines, disconnected,
# no frame, sparse, fluent, instant_prompt=verbose.
...
function prompt_my_padding() {
  p10k segment -t " "
}

function instant_prompt_my_padding() {
  p10k segment -t " "
}

function prompt_my_padding_double() {
  p10k segment -t "  "
}

function instant_prompt_my_padding_double() {
  p10k segment -t "  "
}
